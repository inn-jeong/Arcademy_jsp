...
<body>
	...
	removeArrtibute() 메소드를 사용하여 세션값을 삭제하는 예제입니다.
	<%
		String s_name;
		String s_value = "저는 세션이 저장된 첫 번째 값이에요. ^ㅇ^";
		session.setAttribute("s_name1", s_value);
		
		s_value = "저는 세션에 저장된 두 번째 값이에요. ^ㅇ^";
		session.setAttribute("s_name2", s_value);
		
		s_value = "저는 세션에 저장된 세 번째 값이에요. ^ㅇ^";
		...
		while(enum_app.hasMoreElements()){
			...
			out.print("<br>얻어온 세션 값["+i+"]: "+s_value+"<hr>");
		}
// 		세션 이름이 s_name2 인 것을 삭제 
		session.removeAttribute("s_name2");

		out.print("<hr><h3>--- 세션 값을 삭제하기 후 ---</h3>");
